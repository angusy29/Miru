...
class MalKitUtil {
    ...
    func makeAnimeQuerty(params: Dictionary<String, Any>, type: Int) -> String? {
        ...
        if query[7] as? Date != nil{
            ...
            debugLog("date_start class is not Date / Class is " + String(describing: query[7]))
        }
        if query[8] as? Date != nil{
            ...
            debugLog("date_finish class is not Date / Class is " + String(describing: query[8]))
        }
    ...
    func makeMangaQuerty(params: Dictionary<String, Any>, type: Int) -> String? {
        ...
        if query[6] as? Date != nil {
            ...
            debugLog("date_start class is not Date / Class is " + String(describing: query[6]))
        }
        if query[7] as? Date != nil {
            str += "<date_finish>"
            str += self.dateString(date: query[7] as! Date)
            ...
            debugLog("date_finish class is not Date / Class is " + String(describing: query[7]))
        }
